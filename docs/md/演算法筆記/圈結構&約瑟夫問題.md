...
**一、** 
>Q：當我們已知有8個人時，第3個位置會自殺，勝利者的位置為6。那下一輪3自殺之後，7個人時，勝利者的位置為多少？
>1,2,<span style="border: 2px solid #ff0000;">3</span>,4,5,<span style="border: 2px solid #0011ff;">6</span>,7,8
>
>A：其實，第一輪刪掉編號為3的人後，之後的人都往前面移動了3位，勝利者也往前移動了3位，所以他的位置由6變成3。
如下：
1,2,<span style="border: 2px solid #ff0000;">3</span>,4,5,<span style="border: 2px solid #0011ff;">6</span>,7,8
4,5,<span style="border: 2px solid #0011ff;">6</span>,7,8,1,2




**二、**
>Q：假設我們已經知道10個人且第3個位置會自殺時，勝利者的位置為9。那前一輪11個人時，勝利者的位置為多少？
1,2,3誒,5,6,7,8,9,10
?,?,?,?,?,?,?,?,<span style="border: 2px solid #0011ff;">?</span>,?
>
>A：這可以看作是上一個問題的逆過程，大家都往後移動3位，所以：
假設 f()
>f(11,3) = f(10,3) + 3。
>不過有可能數組會越界，所以最後模上當前人數的個數， 
>f(11,3) = (f(10,3) + 3) % 11 = ( 9 + 3 ) % 11 = 1 ，第一個位置會是勝利者
範例如下：
4, 5, 6, 7, 8, 9,10,11, <span style="border: 2px solid #0011ff;">1</span>, 2
<span style="border: 2px solid #0011ff;">1</span>, 2, <span style="border: 2px solid #ff0000;">3</span>, 4, 5, 6, 7, 8, 9,10,11



**三、**
>Q：現在改為人數改為N，報數到M時，把那個人殺掉，那麼陣列是怎麼移動的？
>
