...
> 如果排序是由小而大，從後端未排序部份選擇一個最小值，並放入前端已排序部份的最後一個(和前面 swap)。例如排序前 70、80、31、37、10、1、48、60、33、85。
...
## 插入排序
> 每次從後端未排序部份取得最前端的值，然後插入(往前 swap)前端已排序部份的適當位置。例如排序前 92、77、67、8、6、84、55、85、43、67。
